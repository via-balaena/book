...
- [Kernel Documentation](./doc/index.md)
  ...
  - [Threat Model](./doc/threat_model/threat_model.md)
    ...
    - [Use Case: Manual Deployment](./doc/threat_model/manual_deployment.md)
    - [Use Case: Signed Image](./doc/threat_model/signed_monolithic.md)
    - [Use Case: App Offload](./doc/threat_model/secure_app_offload.md)
